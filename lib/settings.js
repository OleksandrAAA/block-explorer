...
exports.webserver = {
  ...
  "tls": {
    ...
    "cert_file": "/etc/letsencrypt/live/liveexplorer.chesscoin032.com/cert.pem",
    ...
    "chain_file": "/etc/letsencrypt/live/liveexplorer.chesscoin032.com/chain.pem",
    ...
    "key_file": "/etc/letsencrypt/live/liveexplorer.chesscoin032.com/privkey.pem"
  },
  ...
  "cors": {
    ...
    "corsorigin": "http://liveexplorer.chesscoin032.com"
  }
};
...
exports.shared_pages = {
  ...
  "page_title": "Chesscoin 0.32% | Explorer",
  ...
  "page_footer": {
    ...
    "powered_by_text": "<a class='nav-link poweredby' href='https://github.com/team-exor/eiquidus' target='_blank'>Powered by eIquidus v{explorer_version}</a>"
  }
};
...
exports.markets_page = {
  ...
  "exchanges": {
    ...
    "crex": {
      ...
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
      //                Ex: "LTC/BTC", "LTC/USDT", "LTC/ETH"
      "trading_pairs": [ "CHESS/BTC", "CHESS/USDT" ]
    },
    ...
    // finex: a collection of settings that pertain to the finex exchange
    "finex": {
      // enabled: Enable/disable the finex exchange (true/false)
      //          If set to false, the finex page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": true,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
      //                Ex: "LTC/BTC", "LTC/USDT", "LTC/ETH"
      "trading_pairs": [ "CHESS/BTC" ]
    },
